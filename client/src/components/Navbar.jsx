                        ...
                        <>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div className="hidden md:block">
                                            <div className="ml-10 flex items-baseline space-x-4">
                                                ...
                                                {/* <Disclosure.Button 
                                                    className={classNames('bg-[#6e36a5] text-white hover:bg-gray-700 hover:text-white',
                                            ...
                                            <Menu as="div" className="relative ml-3">
                                                <div>
                                                    <Menu.Button className="relative flex max-w-xs items-center rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                                        ...
                                                        <img className="h-8 w-8 border border-gray-400 rounded-full " src={user.imageUrl} alt="" />
                                                    </Menu.Button>
                                                </div>
                            ...
                            <Disclosure.Panel className="md:hidden">
                                ...
                                <div className="border-t border-gray-700 pb-3 pt-4">
                                    ...
                                    <span className='ps-2'>{userDetails?.firstname} {userDetails?.lastname}</span>
